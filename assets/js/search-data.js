...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "gallery",
          description: "blog posts, collages, and photos",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Gallery",handler: () => {
            ...
            },},{id: "gallery-what-39-s-in-a-streak",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=N3eRG0UAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
